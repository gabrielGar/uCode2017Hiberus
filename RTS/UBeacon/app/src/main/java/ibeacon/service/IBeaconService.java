        ...
        public void handleMessage(Message msg)
        {
             ...
             if (service != null) {
                 ...
                 case MSG_START_RANGING:
                 	...
                 	service.startRangingBeaconsInRegion(startRMData.getRegionData(), new ibeacon.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                    break;
                 ...
                 case MSG_START_MONITORING:
                 	...
                 	service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new ibeacon.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                 	break;
