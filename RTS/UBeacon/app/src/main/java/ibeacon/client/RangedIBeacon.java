...
public class RangedIBeacon extends IBeacon {
	...
	private double calculateRunningAverage() {
		...
		Log.i(TAG, "Running average rssi based on "+size+" measurements: "+runningAverage);
	...
	protected void addRangeMeasurement(Integer rssi) {
		this.rssi = rssi;
		addMeasurement(rssi);
		Log.i(TAG, "calculating new range measurement with new rssi measurement:"+rssi);
